...
impl<CB: CursorRedrawCb + 'static> Cursor<CB> {
    ...
    pub fn snapshot(
        ...
        let (y, w, h) = cursor_rect(self.mode_info(), cell_metrics, y, str_width);
        ...
        match mode_info.cursor_shape() {
            ...
            Some(&mode::CursorShape::Vertical) => {
                ...
                let cursor_width = if cell_percentage > 0 {
                    ...
                    (str_width * cell_percentage as f64) / 100.0
                } else {
                    // char_width
                    str_width
                };
                (line_y, cursor_width, line_height)
                // (line_y, char_width, line_height)
            }
